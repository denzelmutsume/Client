...
-- public functions
function init()
  hotkeysButton = modules.client_topmenu.addLeftGameToggleButton('hotkeysButton', tr('Hotkeys') .. ' (Ctrl+K)', '/images/topbuttons/hotkeys', toggle, 1)
  g_keyboard.bindKeyDown('Ctrl+K', toggle)
  hotkeysButton:setVisible(false)
